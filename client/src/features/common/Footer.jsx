...
function Footer() {
  return (
    <>
      <Browerfooter
      container
      className="border border-t-8 bg-gray-800  border-teal-600 mt-5 hover:shadow-2xl hover:border-t-sky-600">
          <div className="mt-5">
            <div className="flex-1">
              <Link to="/" className="font-bold text-white text-4xl ">
                <span className="px-2 py-1  bg-gradient-to-r from-indigo-500  rounded-lg text-white">
                  Medab 
                </span>
                Pharmaceutical Medical
              </Link>
              <p className="text-md mt-5 w-80 text-white">
